...
<asp:Content ID="Content2" ContentPlaceHolderID="Side1" runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Side2" runat="server">
...
<asp:Content ID="Content4" ContentPlaceHolderID="Side3" runat="server">
