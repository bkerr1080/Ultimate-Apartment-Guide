<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Ultimate_Apartment_Guide.Default" %>
				...
				<div id="three-columns">
					<div id="box1">
						<div class="box1 box-sytle">
							<h2 class="title">Veroeros lorem <span>dolor</span></h2>
							<div class="content">
								<div class="bgtop">
									<div class="bgbtm">
										<p><img src="images/homepage04.jpg" width="220" height="68" alt="" /></p>
					...
					<div id="box2">
						<div class="box2 box-sytle">
							<h2 class="title">Tempus sed <span>consequat</span></h2>
							<div class="content">
								<div class="bgtop">
									<div class="bgbtm">
										<p><img src="images/homepage05.jpg" width="220" height="68" alt="" /></p>
										<p><strong>Blandit tempus duis</strong> id purus laoreet massa ultrices eleifend non vitae dui. Nam elementum augue at gravida in neque nisi vulputate luctus.</p>
										<p class="separator">&nbsp;</p>
										<p class="link"><a href="#">Learn more ...</a></p>
									</div>
					...
					<div id="box3">
						<div class="box3 box-sytle">
							<h2 class="title">Adipiscing amet <span>tempus</span></h2>
							<div class="content">
								<div class="bgtop">
									<div class="bgbtm">
										<p><img src="images/homepage06.jpg" width="220" height="68" alt="" /></p>
										<p><strong>Blandit tempus duis</strong> id purus laoreet massa ultrices eleifend non vitae dui. Nam elementum augue at gravida in neque nisi vulputate luctus.</p>
										<p class="separator">&nbsp;</p>
										<p class="link"><a href="#">Learn more ...</a></p>
									</div>
